...
namespace Pet_Management_System.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Price,picture,Description,LastUpdated,CategoryId,Age,SelectedGender,Gender,Colour,SelectedColor")] Product product, HttpPostedFileBase pictureFile)
        {
            if (ModelState.IsValid)
            {
                ...
                product.Gender = product.SelectedGender.ToString();
                product.Colour = product.SelectedColor.ToString();
